...
> Esta lista se actualiza automáticamente conforme se construye cada pieza. ✅ = hecho, ⬜ = pendiente. El detalle paso a paso está en `docs/specs/2026-06-18-helpmeet-fase1.md`.
