...
- [x] Crear instalador con Inno Setup o MSIX. <!-- script Inno Setup en installer/Helpmeet.iss + scripts/build_release.ps1 (requiere instalar Inno Setup 6) -->
...
> **Cómo generar el instalador:** instala [Inno Setup 6](https://jrsoftware.org/isdl.php) y ejecuta `scripts\build_release.ps1 -Version "<versión>"`. El instalador queda en `dist\installer\Helpmeet-Setup-<versión>.exe`. Para build rapido sin instalador: `scripts\build_dev.ps1`.
...
# Build rapido de desarrollo (solo PyInstaller, sin tests)
.\scripts\build_dev.ps1

# Build completo con tests + instalador
