...
| Whisper local en celular | Bajo | Pesado, lento y poco practico |
...
- Atajos globales.
- Guardar automaticamente en carpetas del sistema como en Windows.

El celular debe ser la extension de consulta y revision, no el motor principal de grabacion.
...
- Permitir elegir que proyecto/reunion compartir.
...
Los botones de grabacion deben ocultarse en mobile.
...
- Si agregas transcripcion en nube, ya no sera gratis.
...
- Token temporal.
- Seleccionar proyecto/reunion a enviar.
